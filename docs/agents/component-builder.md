...
The implementer role for this repository. Takes an agreed design spec and turns
it into framework-agnostic HTML component templates and CSS, previewable
through the local Nunjucks dev server.

This prompt needs file read/write/edit access and shell access (to run the dev
server and build/check scripts).
